...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val idDrawable: Int = when (lemonadeState) {
        ...
        lemonImage?.setImageResource(idDrawable)

        if (idDrawable == R.drawable.lemon_tree) {
            textAction.setText(R.string.lemon_select)
        } else if (idDrawable == R.drawable.lemon_squeeze) {
            textAction.setText(R.string.lemon_squeeze)
        } else if (idDrawable == R.drawable.lemon_drink) {
            textAction.setText(R.string.lemon_drink)
        } else if (idDrawable == R.drawable.lemon_restart) {
